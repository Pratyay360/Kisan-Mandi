      ...
      <main className="container mx-auto py-8 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8 text-center">
            <h1 className="text-3xl font-bold text-green-800 mb-2">Create Farm Product</h1>
            <p className="text-gray-600 max-w-2xl mx-auto">
              List your farm products  and connect with potential buyers.
              Complete all required information to ensure the best visibility for your products.
            </p>
          </div>
                ...
                <div className="p-6 md:p-8">
                  <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                      <TabsContent value="product-details" className="space-y-6 mt-0">
                        <div className="bg-green-50 rounded-lg p-4 mb-6 border border-green-100">
                          <div className="flex items-start gap-3">
                            <Leaf className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                            <div>
                              <h4 className="font-medium text-green-800">Product Information</h4>
                              <p className="text-sm text-green-700">
                                Provide detailed information about your farm product to help buyers make informed decisions.
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <TabsContent value="pricing-details" className="space-y-6 mt-0">
                        <div className="bg-green-50 rounded-lg p-4 mb-6 border border-green-100">
                          <div className="flex items-start gap-3">
                            <Info className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                            <div>
                              <h4 className="font-medium text-green-800">Price & Duration Settings</h4>
                              <p className="text-sm text-green-700">
                                Set your auction parameters to attract the right buyers and maximize your profits.
                              </p>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="bg-amber-50 p-5 rounded-lg border border-amber-100">
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              <h4 className="font-medium text-amber-800">Auction Fee Information</h4>
                              <p className="text-sm text-amber-700">
                                Our platform charges a 5% fee on the final selling price. 
                                This fee helps maintain the platform and provide services 
                                like secure payments, vendor verification, and dispute resolution.
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <TabsContent value="shipping-details" className="space-y-6 mt-0">
                        <div className="bg-green-50 rounded-lg p-4 mb-6 border border-green-100">
                          <div className="flex items-start gap-3">
                            <Info className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                            <div>
                              <h4 className="font-medium text-green-800">Shipping & Final Details</h4>
                              <p className="text-sm text-green-700">
                                Provide shipping options and accept the terms to complete your listing.
                              </p>
                            </div>
                          </div>
                        </div>
